...
//part 2 Began
let guestBiginner: string = "Umar";
guestArray.unshift(guestBiginner);
// console.log(guestArray);

//part 3 Middle
let middleGuest: string = "Laraib";
...
guestArray.map((items) =>
  console.log(
    "Dear " + items + ", you are invited in the more people catogory on dinner."
  )
);
